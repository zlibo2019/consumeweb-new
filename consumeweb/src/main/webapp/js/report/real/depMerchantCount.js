//部门计次营业汇总报表
garen_define("js/report/real/depMerchantCount",function (jqObj,loadParams) {
	...
	var merchQuery = "report/merchant/qryAll.do";//商户查询
	var depTree = null;
...
//	}
	...
	reportObj.parse(jqObj,'部门计次营业汇总报表',exOpts);
