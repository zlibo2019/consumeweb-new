//充值同步提示窗
garen_define("js/account/charge_syncWin",function (jqObj,loadParams) {

	var chargeOperation = "account/chargeOperation.do";//充值操作
...
//	var flag = 1;//寻卡标志
	...
	function charge(){
		$.postEx(chargeOperation,loadParams.params,function(retJson){
			if_complete = 1;
			if(retJson.result){
				if_success = 1;
				searchCard();
