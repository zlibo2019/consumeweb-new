//创建规则
garen_define("js/consume/defaultRule_addRuleList",function (jqObj,loadParams) {
	
	var ruleAdd = "consume/defaultRule/ruleAdd.do";//新增规则
...
//	//查询时间偏移量
//	function timeOffset(){
//		$.loadEx(queryTimeOffset,function(retJson){
//			if(retJson.result && retJson.data){
//				return retJson.data[0].offset;
//			}
//		});
//	}
