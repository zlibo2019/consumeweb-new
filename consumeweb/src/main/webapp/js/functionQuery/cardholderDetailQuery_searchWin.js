garen_define("js/functionQuery/cardholderDetailQuery_searchWin",function (jqObj,loadParams) {
	...
	var searchWinUI = {
		eName:"div",
		cssClass:"cardholderDetailQuery_searchWin",
		elements:[{
			eName:"fieldset",
			width:445,
			height:210,
			...
			elements:[{
				eName:"linkbutton",
				uId:"tm1",
				cssClass:"cardholderDetailQuery_searchWin_linkbutton",
				text : '确定',
				width : 80,
				height : 35,
				onClick:function(){
